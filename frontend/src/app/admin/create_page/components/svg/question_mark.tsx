        ...
        <div className={props.className}>
            <svg width={props.size} height={props.size} viewBox="0 0 24 24" fill="none"
                ...
                <g clip-path="url(#clip0_429_11043)">
                    <circle cx="12" cy="11.9999" r="9" stroke={props.color} stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round"/>
                    <rect x="12" y="16" width="0.01" height="0.01" stroke={props.color} stroke-width="3.75"
                          stroke-linejoin="round"/>
                    <path
                        ...
                        stroke={props.color} stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>

...
export default function SubjectPage(){
    return (
        <div>
            ...
            <Paragraph src={"/img2.jpg"} title={"Titolo 2"} content={content1} layout={1}/>
            <Paragraph src={"/img2.jpg"} title={"Titolo 2"} content={content1} layout={2}/>
            <Paragraph src={"/img2.jpg"} title={"Titolo 2"} content={content1} layout={3}/>
            <Paragraph src={"/img2.jpg"} title={"Titolo 2"} content={content1} layout={4}/>
            <Paragraph src={"/img2.jpg"} title={"Titolo 2"} content={content1} layout={5}/>
